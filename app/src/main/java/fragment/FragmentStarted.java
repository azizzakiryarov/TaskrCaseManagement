...
public class FragmentStarted extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        try {
            if (callBacks != null) {
                callBacks = (FragmentStarted.Callbacks) context;
            }
    ...
    private static final class WorkItemListAdapter extends RecyclerView.Adapter<FragmentStarted.WorkItemListAdapter.WorkItemViewHolder> {
        ...
        private final FragmentStarted.WorkItemListAdapter.OnItemClickedListener onItemClickedListener;

        private WorkItemListAdapter(List<WorkItem> workItems, FragmentStarted.WorkItemListAdapter.OnItemClickedListener onItemClickedListener) {
        ...
        public FragmentStarted.WorkItemListAdapter.WorkItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new FragmentStarted.WorkItemListAdapter.WorkItemViewHolder(itemView);
        }
        ...
        static final class WorkItemViewHolder extends RecyclerView.ViewHolder {
            ...
            void bindView(final WorkItem workItem, final FragmentStarted.WorkItemListAdapter.OnItemClickedListener onItemClickedListener) {
