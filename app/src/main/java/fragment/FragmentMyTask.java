...
public class FragmentMyTask extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        try {
            if (callBacks != null) {
                callBacks = (FragmentMyTask.Callbacks) context;
            }
    ...
    private static final class WorkItemListAdapter extends RecyclerView.Adapter<FragmentMyTask.WorkItemListAdapter.WorkItemViewHolder> {
        ...
        private final FragmentMyTask.WorkItemListAdapter.OnItemClickedListener onItemClickedListener;

        private WorkItemListAdapter(List<WorkItem> workItems, FragmentMyTask.WorkItemListAdapter.OnItemClickedListener onItemClickedListener) {
        ...
        public FragmentMyTask.WorkItemListAdapter.WorkItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new FragmentMyTask.WorkItemListAdapter.WorkItemViewHolder(itemView);
        }
        ...
        static final class WorkItemViewHolder extends RecyclerView.ViewHolder {
            ...
            void bindView(final WorkItem workItem, final FragmentMyTask.WorkItemListAdapter.OnItemClickedListener onItemClickedListener) {
